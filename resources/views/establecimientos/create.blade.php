                    ...
                    <fieldset class="border p-4">
                        <legend class="text-primary">Nombre, Categoría e Imagen Principal</legend>
                            <div class="form-group">
                                ...
                                <input value="{{old('nombre')}}" type="text" name="nombre" id="nombre" class="form-control @error('nombre') is-invalid @enderror" placeholder="Nombre establecimiento"/>
                            </div>
                            @error('nombre')
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{old('imagen_principal')}}" type="file" name="imagen_principal" id="imagen_principal" class="form-control @error('imagen_principal') is-invalid @enderror" placeholder="Nombre establecimiento"/>
                            </div>
                            @error('nombre')
                                <div class="invalid-feedback">
                                    {{$message}}
                    ...
                    <fieldset class="border p-4">
                        <legend class="text-primary">Ubicación</legend>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="direccion" class="form-control @error('direccion') is-invalid @enderror " placeholder="Dirección" id="direccion" value="{{ old('direccion')}}" >
                            </div>
                            @error('direccion')
                                <div class="invalid-feedback">
                                    {{$message}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="colonia" class="form-control @error('colonia') is-invalid @enderror" placeholder="Colonia" id="colonia"  value="{{ old('colonia')}}">
                            </div>
                            @error('colonia')
                                <div class="invalid-feedback">
                                    {{$message}}
